...
{
	/// >>> ERAPDF: fix for extraneous spaces in hitboxes for certain ligatures
	/// now we process all the characters the same way. ligature chars are getting processed on a higher level on hitboxes forming
