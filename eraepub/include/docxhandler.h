...
public:
    ...
    DocxStyle(const DocxStyle &v) : type_(v.type_), fontSize_(v.fontSize_), styleId_(v.styleId_),isDefault_(v.isDefault_),name_(v.name_),outline_lvl_(v.outline_lvl_) {}
    DocxStyle(lString16 type,int fontSize,lString16 styleId,bool isDefault,lString16 name,int outline_lvl) : type_(type)   , fontSize_(fontSize)   , styleId_(styleId)   ,isDefault_(isDefault),name_(name),outline_lvl_(outline_lvl) {}
